...
class UserAddressForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["full_name"].widget.attrs.update(
            {"class": "form-control mb-2 account-form", "placeholder": "请输入你的昵称或姓名(如需)"}
        )
        self.fields["phone"].widget.attrs.update(
            {
                "class": "form-control mb-2 account-form",
                "placeholder": "请输入你的电话/联系方式(QQ/WeChat)",
            }
        )
        self.fields["address_line"].widget.attrs.update(
            {"class": "form-control mb-2 account-form", "placeholder": "请输入你的楼宇(如需)"}
        )
        self.fields["address_line2"].widget.attrs.update(
            {"class": "form-control mb-2 account-form", "placeholder": "详细地址(如需)"}
        )
        self.fields["school"].widget.attrs.update(
            {
                "class": "form-control mb-2 account-form",
                "placeholder": "请输入你的校区(必需!以防止TJUer跑错校区!)",
            }
        )
...
class RegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["name"].widget.attrs.update(
            {"class": "form-control mb-3", "placeholder": "用户名"}
        )
        ...
        self.fields["password"].widget.attrs.update(
            {"class": "form-control mb-3", "placeholder": "密码"}
        )
    ...
    resume = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={
                "class": "form-control mb-3",
                "rows": "7",
                "placeholder": "自我介绍,eg:国豪书院计科大二,喜欢打羽毛球,喜欢看书,喜欢写作业",
                "id": "resume",
            },
        ),
    )
